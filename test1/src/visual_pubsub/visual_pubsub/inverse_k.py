...
class InverseKinematics(Node):
    ...
    def __init__(self):
        ...
        self.target_pos = np.array([2.0, 1.5, 1.0]) 
    ...
    def forward_kinematics(self, q):
        q1, q2, q3 = q
        x = 2.0*np.cos(q1) + 1.5*np.cos(q1+q2) + 0.8*np.cos(q1+q2+q3)
        y = 2.0*np.sin(q1) + 1.5*np.sin(q1+q2) + 0.8*np.sin(q1+q2+q3)
        z = 0
    ...
    def jacobian(self, q):
        ...
        j11 = -(2.0*np.sin(q1) + 1.5*np.sin(q1+q2) + 0.8*np.sin(q1+q2+q3))
        j12 = -(1.5*np.sin(q1+q2) + 0.8*np.sin(q1+q2+q3))
        j13 = -0.8*np.sin(q1+q2+q3)

        j21 = 2.0*np.cos(q1) + 1.5*np.cos(q1+q2) + 0.8*np.cos(q1+q2+q3)
        j22 = 1.5*np.cos(q1+q2) + 0.8*np.cos(q1+q2+q3)
        j23 = 0.8*np.cos(q1+q2+q3)
